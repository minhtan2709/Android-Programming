...
import com.example.assigment2_22h1120116.adapter.GameCurrenciesAdapter;
import com.example.assigment2_22h1120116.adapter.GameCurrenciesAdapter;
...
public class user_screen2 extends AppCompatActivity {
    private Toolbar toolbar;
    private ListView listView;
    private GameCurrenciesAdapter gameCurrenciesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamecurrecies);

        toolbar = findViewById(R.id.toolbargc);
        listView = findViewById(R.id.lvgc);
        listgc = new ArrayList<>();
        gameCurrenciesAdapter = new GameCurrenciesAdapter(getApplicationContext(),listgc);

        listView.setAdapter(gameCurrenciesAdapter);
    ...
    private void loadMoreData() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("thongtinsanpham",listgc.get(position));
                startActivity(intent);
            }
        });
    ...
    private void getData(int Page){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, link, new Response.Listener<String>() {
                ...
                if(response != null && response.length()!= 2){
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            listgc.add(new SanPham(ID,product_name,price,anh,description,product_ID));
                            gameCurrenciesAdapter.notifyDataSetChanged();
                        }
                    }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idsanpham",String.valueOf(idgc));
    ...
    private void GetCategoryId(){
        idgc = getIntent().getIntExtra("category_id",-1);
        Log.d("giatricategory",idgc+"");
    }
